...
zokou({ nomCom: "yts", categorie: "Search", reaction: "✋" }, async (dest, zk, commandeOptions) => {
  ...
  try {
    ...
    // repondre(captions)
    haikal.sendMessage(dest, { image: { url: resultat[0].thumbnail }, caption: captions }, { quoted: ms });
  } catch (error) {
...
_*En cours de téléchargement...*_\n\n`
    ...
    */
    ...
    fileStream.on('finish', () => {
      ...
      haikal.sendMessage(origineMessage, { video: { url: `./${filename}` }, caption: "Powered by *Bmw-Md*", gifPlayback: false }, { quoted: ms });
